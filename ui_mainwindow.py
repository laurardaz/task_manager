...
"")
        ...
        self.from_time_pjt.setMaximumDateTime(QDateTime(QDate(9998, 12, 30), QTime(7, 59, 59)))
        ...
        self.task_info_description = QTextBrowser(self.tab_info_task)
        self.task_info_description.setObjectName(u"task_info_description")
        self.task_info_description.setMaximumSize(QSize(16777215, 60))

        self.verticalLayout_25.addWidget(self.task_info_description)
